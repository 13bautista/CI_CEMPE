...
class Users_model extends CI_Model
{
    ...
    {
        $query = $this->db->query("SELECT COUNT(id) AS count, MONTHNAME(FROM_UNIXTIME(created_at)) AS month_name
        FROM usuario WHERE YEAR(FROM_UNIXTIME(created_at)) < '2021' GROUP BY MONTHNAME(FROM_UNIXTIME(created_at));");
