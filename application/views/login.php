                        ...
                        <div class="row">
                            <div class="col">
                                <div class="p-5">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user <?= (form_error('password') ? 'is-invalid' : ''); ?>" style="background-color: rgba(0, 0, 0, 0);" name="password" placeholder="Contraseña">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?= site_url('register'); ?>">Crear cuenta</a>
                                    </div>
                                </div>
                            </div>
                        </div>
